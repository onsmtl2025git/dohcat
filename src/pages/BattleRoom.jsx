...
const BattleRoom = () => {
    ...
    const RenderStatus = () => (
        <div className="flex flex-col gap-6 h-full lg:col-span-3">
            ...
            {/* Blue Return Button - Now Persistent in Status Panel */}
    ...
    const RenderCeremony = () => (
        <div className="lg:col-span-6 w-full h-full min-h-[60vh] floating-card bg-white dark:bg-gray-800 rounded-[3rem] flex flex-col items-center justify-center p-8 relative overflow-hidden shadow-3d-orange border-4 border-yellow-200">
